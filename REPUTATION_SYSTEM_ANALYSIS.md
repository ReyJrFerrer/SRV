...
3. **Transaction Execution** (lines 119-224)
   ...
   **Write Operations:**
   ...
   newReview = {
     ...
     bookingId, clientId, providerId, serviceId,
     rating, comment,
     createdAt, updatedAt,
     status: "Visible",
...
reviewBombPatterns = ["template_language", "coordinated_pattern",
                      "repeated_structure", "suspicious_timing"]
...
recentReviews = db.collection(collectionName)
