    ...
    <View style={styles.container}>
      <View style={styles.stackWrapper}>
        <Stack screenOptions={{ headerBackVisible: false, headerTitleAlign: "center" }}>
          ...
          <Stack.Screen name="receipt/[bookingId]" options={{ title: "Receipt" }} />
          <Stack.Screen name="rate-client/[bookingId]" options={{ title: "Rate Client" }} />
          <Stack.Screen name="directions/[bookingId]" options={{ title: "Directions" }} />
          <Stack.Screen name="active-service/[bookingId]" options={{ title: "Active Service" }} />
          <Stack.Screen name="complete-service/[bookingId]" options={{ title: "Complete Service" }} />
        </Stack>
      </View>
      <BottomNavBar />
    </View>
