...
| Service                          | File                                | Purpose                                                                                                                                                                              |
| -------------------------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `chatCanisterService`            | `chatCanisterService.ts`            | Firestore chat: `subscribeToConversationSummaries()`, `subscribeToMessages()`, `sendMessage()` (supports Text + File types), `markConversationAsRead()`, `getOrCreateConversation()` |
