...
const NotificationsPage = lazy(() => import("./src/pages/client/notifications"));
...
const ClientBookService = lazy(
  () => import("./src/pages/client/book/[id]"),
);
...
const ProviderHelpSupportPage = lazy(
  () => import("./src/pages/provider/help"),
);
