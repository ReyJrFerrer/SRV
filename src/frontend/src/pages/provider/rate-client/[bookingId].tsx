  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-50 pb-24">
      ...
      <main className="mx-auto w-full max-w-4xl flex-1 p-4">
        <div className="mx-auto mb-8 w-full rounded-2xl border border-blue-100 bg-white p-6 shadow">
          <h3 className="mb-4 text-lg font-extrabold tracking-tight text-blue-700">
            Booking Summary
          </h3>
        ...
        <div className="mb-8 px-2 py-4 sm:px-8 sm:py-6">
          ...
          <textarea
            ...
            className="min-h-[96px] w-full resize-none rounded-xl border border-gray-300 p-3 text-base shadow focus:outline-none focus:ring-2 focus:ring-blue-400 disabled:bg-gray-100"
            rows={4}
            value={feedback}
