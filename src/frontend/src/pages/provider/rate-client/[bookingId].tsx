    ...
    <div className="flex min-h-screen flex-col bg-gray-50 pb-24">
      ...
      <main className="mx-auto w-full max-w-4xl flex-1 p-4">
        ...
        <div className="grid grid-cols-1 gap-4 text-base text-gray-700 md:grid-cols-2">
          <div>
            <span className="font-bold">Client:</span> {booking.clientName || "Client"}
          </div>
          <div>
            <span className="font-bold">Service:</span> {booking.serviceName}
          </div>
          <div>
            <span className="font-bold">Package:</span> {booking.packageName}
          </div>
          <div>
            <span className="font-bold">Price:</span> ₱{(booking.price || 0).toFixed(2)}
          </div>
        </div>
      </div>
