...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <div className="group relative flex flex-col items-center rounded-2xl border border-blue-100 bg-white p-6 shadow transition-all duration-200 hover:-translate-y-1 hover:shadow-xl">
      ...
      {/* Service Name */}
      <h4
        className="mb-0 line-clamp-1 w-full break-words text-center text-xl font-bold text-blue-900"
      ...
      <div className="relative z-10 mt-4 grid w-full grid-cols-2 gap-2">
        ...
        >
          <button
            className={`flex w-full items-center justify-center gap-2 rounded-lg px-2 py-1 text-xs font-semibold transition-colors lg:text-lg ${
