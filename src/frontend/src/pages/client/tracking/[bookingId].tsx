...
const ClientTrackingPage: React.FC = () => {
    ...
    const mapApiKey = import.meta.env.VITE_GOOGLE_MAPS_API_KEY || "REPLACE_WITH_KEY";
    ...
    useEffect(() => {
        ...
        const location = (booking as any)?.formattedLocation || (booking as any)?.location;
    ...
    useEffect(() => {
        ...
        if (!booking) {
            navigate("/client/booking/myBookingsPage", { replace: true });
            return;
        }
    ...
    }, [booking, bookingsLoading, bookingId, navigate]);
        ...
        <div className="relative h-screen w-screen overflow-hidden bg-gray-100">
            ...
            {locationLoading && !providerLocation && (
                <div className="absolute left-1/2 top-1/3 z-20 -translate-x-1/2 rounded-xl bg-white/95 p-6 text-center shadow-lg backdrop-blur">
                    ...
                    <p className="mt-3 font-medium text-gray-700">Connecting to provider...</p>
                    <p className="mt-1 text-sm text-gray-500">Please wait while we locate your provider</p>
                </div>
            )}
