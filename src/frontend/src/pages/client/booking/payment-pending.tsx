...
const PaymentPendingPage: React.FC = () => {
  ...
  useEffect(() => {
    const checkPaymentStatus = () => {
      if (state?.invoiceId) {
        const paymentResult = localStorage.getItem(`payment_${state.invoiceId}`);
        if (paymentResult) {
          ...
          <div className="p-6">
            ...
            <div className="mb-6 text-center">
              {paymentStatus === 'pending' && (
                <>
                  <ClockIcon className="mx-auto mb-3 h-16 w-16 text-blue-500 animate-pulse" />
            ...
            <div className="mb-6 rounded-lg border border-gray-200 bg-gray-50 p-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{state.bookingData.serviceName}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Total Amount:</span>
                  <span className="font-medium">₱{state.bookingData.totalPrice.toFixed(2)}</span>
                </div>
                <div className="flex justify-between">
              ...
              {paymentStatus === 'pending' && (
                <>
                  <button
                    ...
                    className="w-full rounded-lg bg-blue-600 py-3 font-semibold text-white transition-colors hover:bg-blue-700 flex items-center justify-center"
                  >
            ...
            {paymentStatus === 'pending' && (
              <div className="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-3">
                <p className="text-xs text-blue-700">
                  <strong>Instructions:</strong> Complete your payment in the GCash app or payment page. 
