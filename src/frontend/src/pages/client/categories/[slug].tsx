...
const CategoryPage: React.FC = () => {
  ...
  const [pendingMaxPrice, setPendingMaxPrice] = useState(1000000);
  ...
  // Reputation map for visible services
  ...
  useEffect(() => {
    if (!sortedAndFilteredServices || sortedAndFilteredServices.length === 0)
      return;
    const toFetch = sortedAndFilteredServices.filter(
  ...
  }, [sortedAndFilteredServices, fetchUserReputation, serviceDataMap]);
      ...
      <div className="sticky top-0 z-40 bg-white px-4 py-4 shadow-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="relative rounded-2xl bg-gray-100 px-5 py-3.5 text-gray-600 hover:bg-gray-200 font-bold active:scale-95 transition-all duration-300"
          >
            ...
            <div className="grid grid-cols-1 items-end gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="w-full rounded-2xl bg-blue-600 px-5 py-3.5 text-sm font-black text-white hover:bg-yellow-400 active:scale-95 shadow-sm transition-all duration-300"
                >
                  Apply Filters
                </button>
              </div>
