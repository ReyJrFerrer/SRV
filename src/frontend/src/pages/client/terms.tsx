      ...
      <div className="prose prose-lg text-gray-800">
        <div>
          ...
          <p className="mt-2">
            ...
            with independent service providers ("Service Providers") across the
            Philippines.
          </p>
          <p className="mt-2">
            By downloading, accessing, registering, or using the Platform in any
            way, you acknowledge that you have read, understood, and agree to be
            bound by these Terms and our Privacy Policy. If you do not agree to
            all of these Terms or the Privacy Policy, you must not use the
            Platform.
          </p>
          <p className="mt-2">
            This agreement is a legally binding electronic contract between you
            ("User," "you," "your") and SRV ("SRV," "we," "us," "our"), in
            accordance with the Republic Act No. 8792 (E-Commerce Act of 2000).
          </p>
          ...
          <ol className="list-none pl-1">
            <li>
              ...
              <ul className="mt-1 list-disc pl-5">
                ...
                <li>
                  ...
                  including facilitating connections, enabling bookings,
            ...
            <li>
              ...
              <ul className="mt-1 list-disc pl-5">
                <li>
                  <b>Accuracy:</b> Each User must provide current, accurate, and
                  complete information during registration and update it as
                  needed.
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="mt-1 pl-5">
                <li>
                  ...
                  <ul className="mt-1 list-disc pl-5">
                    <li>
                      Use the Platform in compliance with all applicable laws of
                ...
                <li>
                  ...
                  <ul className="mt-1 list-disc pl-5">
                    ...
                    <li>
                      ...
                      compliance with the Consumer Act of the Philippines
            ...
            <li>
              ...
              <ul className="mt-1 list-disc pl-5">
                <li>
                  <b>Profile & Services:</b> Service Providers must maintain an
                  accurate profile, clearly describe offerings, pricing,
                ...
                <li>
                  ...
                  platform monitors provider performance in real-time based on
                  ratings, complaints, and job completion rates. Automated
                  alerts are issued if a provider's average rating falls below a
                  set threshold. Providers with low ratings receive in-app or
                  email notifications including feedback and improvement tips,
                  and are given time to improve. Failure to show improvement may
                  result in temporary suspension of new bookings. Continued poor
                  performance or verified serious complaints may lead to
                  permanent account deactivation. All actions are documented,
                  and providers are notified formally. Providers have the right
                  to appeal suspensions or deactivations within a specified
                  period, with appeals reviewed by an admin or quality assurance
                  team. Accounts may be reinstated if unfair ratings or system
                  errors are verified.
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="mt-1 list-disc pl-5">
                <li>
                  <b>Cash Transactions:</b> Payments between Client and Service
                  Provider may occur outside the Platform (e.g. cash). SRV's
                  role is to facilitate and record confirmations but SRV is not
            ...
            <li>
              ...
              <ul className="mt-1 list-disc pl-5">
                ...
                <li>
                  ...
                  content. By posting, Users grant SRV a worldwide,
                  non-exclusive, royalty-free license (including sublicensing)
                  to use, display, adapt, distribute, or promote that content in
            ...
            <li>
              ...
              <ul className="mt-1 list-disc pl-5">
                <li>
                  ...
                  (including merchantability, fitness for a purpose, or
                  non-infringement).
                </li>
                <li>
                  SRV does not guarantee uninterrupted, secure, or error-free
                  operation, nor that defects will be corrected or the Platform
                  will be virus-free.
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="mt-1 list-disc pl-5">
                <li>
                  To the fullest extent permitted under Philippine law, neither
                  SRV nor its directors, officers, employees, or agents shall be
                  liable for indirect, incidental, special, consequential, or
                  punitive damages (e.g. loss of profits, data, goodwill)
                  arising out of use or inability to use the Platform, user
                  interactions, third-party services, or blockchain features.
                </li>
                <li>
                  In no event shall SRV's aggregate liability exceed the greater
                  of PHP 100.00 or the total Platform fees paid by the User
                  during the six (6) months immediately preceding the event
            ...
            <li>
              ...
              <ul className="mt-1 pl-5">
                <li>
                  ...
                  and successors from claims, liabilities, damages, losses,
            ...
            <li>
              ...
              <ul className="mt-1 list-disc pl-5">
                <li>
                  These Terms are governed by Philippine law, without regard to
                  conflict of law principles. Any legal proceedings shall be
                  brought exclusively in courts located in Baguio City,
                  Philippines.
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="mt-1 list-disc pl-5">
                <li>
                  SRV may modify or replace these Terms at its sole discretion.
                  For material changes, reasonable notice will be provided (e.g.
                  via in-app notification or email) before the new version takes
                  effect.
                </li>
                <li>
