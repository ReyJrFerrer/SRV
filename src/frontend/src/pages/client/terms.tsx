    ...
    <div className="mx-auto max-w-3xl p-8">
      ...
      <div className="prose prose-lg text-gray-800">
        <p>
          ...
          access to and use of the SRV website, mobile application, and related
          services (collectively, the "Platform"). The Platform is owned and
          operated by SRV, a platform based in Baguio City, Philippines.
          <br />
          <br />
          ...
          the Platform. If you do not agree to these Terms, you must not use the
          Platform.
          <br />
          <br />
          ...
          <br />
          User: Any individual who creates an account on the Platform, including
          ...
          <br />
          Commission Fee: The service fee charged by SRV to the Provider for the
          use of the Platform, calculated as a percentage of the total Service
          price.
          <br />
          Outstanding Commission: The cumulative, running balance of unpaid
          Commission Fees owed by a Provider to the Platform. This is a measure
          of debt and is not electronic money.
          <br />
          Commission Credit Limit: The maximum allowable Outstanding Commission
          a Provider may accrue before their ability to accept new jobs is
          automatically and temporarily restricted.
          <br />
          <br />
          <strong>2. The Platform's Role</strong>
          <br />
          SRV is a technology platform that connects Clients seeking services
          with independent Service Providers who can provide those services. You
          acknowledge that:
          <br />
          SRV is not an employer of Service Providers. Providers are independent
          contractors.
          <br />
          SRV is not a direct party to the agreements made between Clients and
          Providers.
          <br />
          SRV does not directly perform the Services and is not responsible for
          the quality, timing, legality, or any aspect of the Services provided,
          except as explicitly stated in these Terms. Our role is limited to
          facilitating the connection and providing the features described
          herein.
          <br />
          <br />
          ...
          <br />
          Cash Payments: The primary method of payment for Services is a direct
          cash payment from the Client to the Service Provider upon completion
          of the Service. The Platform does not process these payments.
          <br />
          ...
          <br />
          Accrual of Outstanding Commission: Upon confirmation that a cash-based
          job is complete, the Platform will automatically calculate the
          Commission Fee and add this amount to the Provider's Outstanding
          Commission balance. This is an automated accounting of debt owed to
          the Platform.
          <br />
          Payment of Outstanding Commission: Providers are obligated to settle
          their Outstanding Commission balance regularly. Payments shall be made
          via GCash to the official company account specified within the
          Platform. Providers must submit proof of payment (e.g., a transaction
          receipt screenshot) through the designated in-app upload facility for
          verification.
          <br />
          Commission Credit Limit: The Platform enforces a Commission Credit
          Limit (e.g., ₱500.00). If a Provider's Outstanding Commission meets or
          exceeds this limit, their account will be automatically and
          ...
          they offer.
          <br />
          Perform Services to a professional standard of quality, in compliance
          with the Consumer Act of the Philippines (Republic Act No. 7394).
          <br />
          ...
          <br />
          Make full cash payment directly to the Provider for services rendered.
          <br />
          <br />
          ...
          post content that is false, defamatory, obscene, or infringing on any
          third-party rights, including intellectual property rights under the
          ...
          <br />
          We may, at our sole discretion, suspend or terminate your account and
          access to the Platform without prior notice for any breach of these
          ...
          party on the Platform, including any defamatory, offensive, or illegal
          conduct of other users or third parties; or (c) any services provided
          by Service Providers.
          <br />
          <br />
          <strong>9. Data Privacy</strong>
          <br />
          Your privacy is important to us. We collect and process your personal
          data in accordance with our Privacy Policy and the Data Privacy Act of
          2012 (Republic Act No. 10173). By using the Platform, you consent to
          such collection and processing. Please review our Privacy Policy for
          more information.
          <br />
          <br />
          ...
          Philippines. You agree that any legal action or proceeding arising out
          of these Terms shall be brought exclusively in the competent courts of
          Baguio City.
          <br />
