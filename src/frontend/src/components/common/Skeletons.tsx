...
export const ServiceCardSkeleton: React.FC<ServiceCardSkeletonProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Content placeholder */}
      <div className="p-4">
        <div className="mb-2 h-5 w-3/4 rounded bg-gray-200 animate-pulse" />
        <div className="mb-3 h-4 w-1/2 rounded bg-gray-200 animate-pulse" />
        <div className="mb-2 h-4 w-2/3 rounded bg-gray-200 animate-pulse" />
...
export const ServiceGridSkeleton: React.FC<{ count?: number }> = ({ count = 8 }) => {
  return (
...
export const ListItemSkeleton: React.FC = () => (
  <div className="flex items-start gap-4 p-4">
    ...
    <div className="min-w-0 flex-1">
      ...
      <div className="mb-1 h-3 w-2/3 rounded bg-gray-200 animate-pulse" />
      <div className="h-3 w-1/4 rounded bg-gray-200 animate-pulse" />
    </div>
    <div className="mt-2 h-2.5 w-2.5 rounded-full bg-gray-200 animate-pulse" />
  </div>
);
  ...
  <div className="w-full rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
    <div className="mb-3 flex items-start gap-3">
      ...
      <div className="flex-1">
        <div className="mb-2 h-4 w-2/3 rounded bg-gray-200 animate-pulse" />
        <div className="mb-1 h-3 w-1/3 rounded bg-gray-200 animate-pulse" />
        <div className="h-3 w-1/4 rounded bg-gray-200 animate-pulse" />
      </div>
    </div>
