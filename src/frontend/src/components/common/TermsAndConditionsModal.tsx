        ...
        >
          <div className="mb-4">
            ...
            <p className="mt-2">
              ...
              with independent service providers ("Service Providers") across
              the Philippines.
            </p>
            <p className="mt-2">
              ...
              agree to all of these Terms or the Privacy Policy, you must not
              use the Platform.
            </p>
            <p className="mt-2">
              This agreement is a legally binding electronic contract between
              you ("User," "you," "your") and SRV ("SRV," "we," "us," "our"), in
              accordance with the Republic Act No. 8792 (E-Commerce Act of
              2000).
            </p>
          </div>
