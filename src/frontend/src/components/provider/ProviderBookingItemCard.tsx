            ...
            <div className="flex w-full flex-wrap gap-2">
              ...
              {isCompleted && (
                <button
                  ...
                  className="flex flex-1 items-center justify-center rounded-lg border border-yellow-200 bg-yellow-50 px-4 py-2 text-xs font-semibold text-yellow-700 shadow-sm transition hover:bg-yellow-100"
                >
