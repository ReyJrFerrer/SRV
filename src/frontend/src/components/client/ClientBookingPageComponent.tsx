...
const ClientBookingPageComponent: React.FC = () => {
  ...
  if (loading)
    return <div className="p-10 pt-20 text-center">Loading service details...</div>;
  if (error)
    return <div className="p-10 pt-20 text-center text-red-500">{String(error)}</div>;
  if (!service)
    return <div className="p-10 pt-20 text-center">Service not found.</div>;
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-blue-50 via-white to-yellow-50">
      ...
      <div className="flex-grow pb-36 md:pb-28">
        <div className="mt-10 mx-auto max-w-5xl px-2 py-8 md:px-0">
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 border-t border-gray-200 bg-white p-4 shadow-2xl md:sticky">
        <div className="mx-auto max-w-md">
          ...
          <button
            ...
            className="flex w-full items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 to-yellow-400 px-8 py-4 text-lg font-bold text-white shadow-lg transition-colors hover:from-yellow-400 hover:to-blue-600 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {isSubmitting && (
