...
const BottomNavigation: React.FC = () => {
  ...
  const bookingNotificationCount = React.useMemo(
    () =>
      notifications.filter(
        (n) => !n.read && n.bookingId && n.type !== "chat_message",
      ).length,
    [notifications],
  );
  ...
  return (
    <>
      ...
      <aside className="tour-client-nav-desktop safe-area-inset-left fixed left-0 top-0 z-40 hidden h-screen w-20 border-r border-gray-100 bg-white pt-4 shadow-[10px_0_30px_-15px_rgba(0,0,0,0.05)] md:flex md:flex-col">
