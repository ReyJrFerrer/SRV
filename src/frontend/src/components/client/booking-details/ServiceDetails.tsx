  ...
  return (
    <div className="pt-4 lg:col-span-3 lg:pl-8">
      <h3 className="mb-4 flex items-center gap-2 text-lg font-extrabold tracking-tight text-yellow-700">
        <BriefcaseIcon className="h-4 w-4 lg:h-5 lg:w-5 text-yellow-400" /> Service Details
      </h3>
      <div className="space-y-3 text-base">
        <div className="flex items-start ">
          <ArchiveBoxIcon className="mr-2 mt-0.5 h-4 w-4 lg:h-5 lg:w-5 flex-shrink-0 text-blue-600" />
        ...
        <div className="flex items-start ">
          <CalendarDaysIcon className="mr-2 mt-0.5 h-4 w-4 lg:h-5 lg:w-5 flex-shrink-0 text-blue-600" />
          <span>
        ...
        <div className="flex items-start ">
          <MapPinIcon className="mr-2 mt-0.5 h-4 w-4 lg:h-5 lg:w-5 flex-shrink-0 text-blue-600" />
          <span>
        ...
        {price != null && (
          <div className="flex items-start ">
            <CurrencyDollarIcon className="mr-2 mt-0.5 h-4 w-4 lg:h-5 lg:w-5 flex-shrink-0 text-blue-600" />
            <span>
