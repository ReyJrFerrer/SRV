          ...
          <div className="mx-4 w-full max-w-md rounded-lg bg-white shadow-xl">
            ...
            <div className="flex justify-end space-x-3 bg-gray-50 px-6 py-4">
              <button
                ...
                className="rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancel
              </button>
              <button
                ...
                disabled={updatingReputation}
                className="rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
              >
                {updatingReputation ? (
                  <>
          ...
          <div className="mx-4 w-full max-w-md rounded-lg bg-white shadow-xl">
            ...
            <div className="flex justify-end space-x-3 bg-gray-50 px-6 py-4">
              ...
              <button
                ...
                disabled={lockingAccount}
                className="rounded-md border border-transparent bg-yellow-600 px-4 py-2 text-sm font-medium text-white hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
              >
                {lockingAccount ? (
                  <>
                    <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
