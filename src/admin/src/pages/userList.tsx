...
export const UserListPage: React.FC = () => {
  ...
  const handleLockToggle = async () => {
    ...
    try {
      await adminServiceCanister.toggleUserLock(selectedUser.id, !selectedUser.isLocked);
      ...
      alert(`Failed to ${selectedUser.isLocked ? 'unlock' : 'lock'} user. Please try again.`);
    } finally {
          ...
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-2 text-sm text-gray-600">
                  Are you sure you want to permanently delete <span className="font-semibold">{selectedUser.name}'s</span> account? This action cannot be undone and will delete:
                </p>
