...
export const TicketDetailsPage: React.FC = () => {
  ...
  const handleStatusChange = async (newStatus: string) => {
    ...
    try {
      ...
      const { updateReportStatus } = await import("../services/adminServiceCanister");
      ...
      if (success) {
        ...
        setTicket(prev => prev ? {
          ...
          assignedTo: newStatus === 'in_progress' ? 'Admin_001' : (newStatus === 'open' ? undefined : ticket.assignedTo)
        } : null);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <div className="w-8 h-8 animate-spin rounded-full border-b-2 border-blue-600 mx-auto"></div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">The ticket you're looking for doesn't exist.</p>
          <button
                    ...
                    {ticket.comments.map((comment) => (
                      <div
                        ...
                        className={`p-4 rounded-lg ${
                          comment.isInternal ? 'bg-blue-50 border-l-4 border-blue-400' : 'bg-gray-50'
                        }`}
                      >
              ...
              <div className="px-6 py-4 space-y-3">
                ...
                {updatingStatus && (
                  <div className="flex items-center text-sm text-gray-500">
                    <div className="w-4 h-4 animate-spin rounded-full border-b-2 border-indigo-600 mr-2"></div>
                    Updating status...
                  </div>
                )}
              </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
              ...
              <div className="px-6 py-4 space-y-4">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{formatDate(ticket.submittedAt)}</dd>
                </div>
                
                <div>
                  <dt className="text-sm font-medium text-gray-500">Last Updated</dt>
                  <dd className="mt-1 text-sm text-gray-900">{formatDate(ticket.lastUpdated)}</dd>
                </div>
