...
exports.deleteService = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    if (!bookingsSnapshot.empty) {
      ...
      console.log(`✅ [deleteService] Deleted ${bookingsSnapshot.size} bookings for service ${serviceId}`);
    }
    ...
    if (!reviewsSnapshot.empty) {
      ...
      console.log(`✅ [deleteService] Deleted ${reviewsSnapshot.size} reviews for service ${serviceId}`);
    }
    ...
    if (!providerReviewsSnapshot.empty) {
      ...
      console.log(`✅ [deleteService] Deleted ${providerReviewsSnapshot.size} provider reviews for service ${serviceId}`);
    }
